# OpenClaw service for Wodby

Use OpenClaw as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public OpenClaw service in the Wodby catalog.

- [OpenClaw service in the Wodby catalog](https://wodby.com/services/openclaw)
...
4. Reference `openclaw` from your stack manifest.
